  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        ...
        attrs[Formbuilder.options.mappings.ADD_MORE] = false;
...
(function() {
  Formbuilder.registerField('location', {
    ...
    view: "<div class='input-line'>\n     <span class='dolars'>\n    <input type='text' />\n     </span>\n  <span class='above-line'></span>\n </div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-map-marker\"></span></span> Location",
    defaultAttributes: function(attrs) {
      attrs.field_options.description = 'You may have to allow the location for this page. Make sure to click the location icon in the top right corner of the browser and try again.';
      return attrs;
...
(function() {
  Formbuilder.registerField('esignature', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-pencil\"></span></span> E-Signature",
    defaultAttributes: function(attrs) {
      attrs.field_options.description = 'Make sure to draw by touching the signature area to sign this eForm.';
      return attrs;
...
'\' />\n  Required\n</label>\n <label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
((__t = ( Formbuilder.options.mappings.ADD_MORE )) == null ? '' : __t) +
'\' />\n  AddMore\n</label>\n<!-- label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
